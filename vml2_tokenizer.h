 ...
 */
#ifndef __VML2_TOKENIZER_H__  
#define __VML2_TOKENIZER_H__  
...
namespace vml2 
{
  ...
  //::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
  {
    ...
    public:
      ...
      file_stream( const T & filename ) throw() : 
        _filename(filename),
        _fstrm(0)
      {
      }
  ...
  //::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
  {
    ...
    public:
      ...
      //------------------------------------------------------------------------
        ...
        inline bool operator == (const token_t& obj) const throw() 
        { 
      ...
      //------------------------------------------------------------------------
        ...
        inline bool operator == (const T& str) const throw() 
        { 
          return value == str;
        }
    ...
    public:
      ...
      inline T get_current_line_buf() const throw() 
      { 
      ...
      inline void register_token_blank( token_class_set_t clset ) throw() 
      {
      ...
      inline void register_token_atomic( token_class_set_t clset ) throw() 
      {
      ...
      inline void register_token_linestyle_comment( token_class_set_t clset ) 
      throw() 
      {
      ...
      inline int get_line_num() const throw() 
      { 
      ...
      inline int get_col_num() const throw() 
      {
        return _current_col;
      }
      ...
      inline void set_line_delimiter( char delimiter ) throw() 
      {
      ...
      inline char get_line_delimiter() const throw() 
      {
      ...
      inline static
      size_t search_token_pos(const T& token, 
                              const T& line, 
      ...
      static
      size_t search_token_class_pos( T & token_found,
   ...
   public:
     ...
     inline token_t get_last_token_processed() const throw() 
     { 
