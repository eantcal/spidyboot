...
//::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
{
  public:
    ...
    static
      void rebase_immr( addr_t base, addr_t newbase, assignlist_t & lst )
      {
  ...
  private:
    typedef vml2::tokenizer_t< std::string > tokenizer_t;
  ...
  public:
    ...
    bool compile_cfg( const std::string & filename, 
        ...
        std::string& msg )
    {
      vml2::file_stream< std::string> fs( filename );
      tokenizer_t t( fs );
...
//------------------------------------------------------------------------------
    ...
    inline void show_version() const throw()
    {
